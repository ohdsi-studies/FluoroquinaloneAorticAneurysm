...
```{r fluoroquinolones, echo=FALSE}
fluoroquinolones <- readr::read_delim(col_names = FALSE, delim = ";", trim_ws = TRUE, file = "
...
")
tab <- knitr::kable(fluoroquinolones, col.names = NULL, linesep = "", booktabs = TRUE)
if (knitr::is_latex_output()) {
  tab %>% kable_styling(latex_options = c("striped", "hold_position"), 
                        font_size = latex_table_font_size)
} else {
